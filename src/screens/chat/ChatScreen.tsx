...
function ChatStaticHeader({
  ...
  return (
    <header
      className="absolute left-0 top-0 h-[calc(var(--qling-space-safe-top)+202px)] w-full overscroll-none bg-[#ff8b3d]"
      onTouchMove={blockStaticScroll}
      onWheel={blockStaticScroll}
    >
      <h1 className="absolute left-0 top-[calc(var(--qling-space-safe-top)+34px)] w-full text-center text-[17px] font-extrabold leading-normal tracking-[-0.34px] text-white">
        채팅
      </h1>
      <button
        type="button"
      ...
      <label className="absolute left-4 right-4 top-[calc(var(--qling-space-safe-top)+75px)] flex h-10 items-center gap-2 rounded-[14px] bg-white/[0.22] px-3">
