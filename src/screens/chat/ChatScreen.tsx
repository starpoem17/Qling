  ...
  return (
    <section className="-mx-[var(--qling-space-shell-x)] -mb-[var(--qling-space-scroll-bottom)] -mt-6 h-dvh overflow-hidden bg-[#ff8b3d] text-[#2a2a2a]" onClick={() => setOpenMenuId(null)}>
      <div className="mx-auto flex h-full w-full max-w-[480px] justify-center overflow-hidden">
        ...
        >
          {/* Top Bar */}
          <div className="pt-[54px] px-6 flex justify-between items-center text-white">
          ...
          {/* Bottom Sheet Area */}
          <div className="absolute left-0 top-[180px] h-[672px] w-full overflow-y-auto px-[18px] pt-6 pb-[108px] bg-[#fff1d1] rounded-t-[30px] z-10 scrollbar-hide">
            {loading ? (
                  ...
                  >
                    ...
                    <div className="flex items-start w-full gap-4">
                        ...
                        <div className="relative shrink-0">
                            <div className="w-[52px] h-[52px] rounded-full flex items-center justify-center overflow-hidden" style={{ backgroundColor: chat.opponentColor || '#FF8B3D' }}>
                               <div className="w-[20px] h-[10px] bg-white rounded-full flex items-center justify-center gap-[2px]">
                                  <div className="w-[5px] h-[7px] bg-[#2a2a2a] rounded-full"></div>
                                  <div className="w-[5px] h-[7px] bg-[#2a2a2a] rounded-full"></div>
                               </div>
                            </div>
                            {/* Online dot */}
