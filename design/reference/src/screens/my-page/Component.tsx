import svgPaths from "./svg-doo5q6fili";
    ...
    <div className="absolute h-[26.34px] left-[24px] top-[12px] w-[33.116px]" data-name="Profile image container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 33.1161 26.3397">
        <g id="Profile image container">
          ...
          <g id="Mask group">
            <mask height="27" id="mask0_3_274" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
          ...
          <g id="Mask group_2">
            <mask height="27" id="mask1_3_274" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
              <path d={svgPaths.pc94fd00} fill="var(--fill-0, #FFF5EB)" id="Ellipse_4" />
            </mask>
            <g mask="url(#mask1_3_274)">
              <path d={svgPaths.pab18a00} fill="var(--fill-0, #1A1A1A)" id="Ellipse_5" />
            </g>
          </g>
          <g id="Mask group_3">
            <mask height="27" id="mask2_3_274" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
              <path d={svgPaths.pc94fd00} fill="var(--fill-0, #FFF5EB)" id="Ellipse_6" />
            </mask>
            <g mask="url(#mask2_3_274)">
          ...
          <g id="Mask group_4">
            <mask height="27" id="mask3_3_274" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="17" x="17" y="0">
              <path d={svgPaths.p1c90a780} fill="var(--fill-0, #FFF5EB)" id="Ellipse_9" />
            </mask>
            <g mask="url(#mask3_3_274)">
              <path d={svgPaths.p4179200} fill="var(--fill-0, #1A1A1A)" id="Ellipse_10" />
            </g>
          </g>
          <g id="Mask group_5">
            <mask height="27" id="mask4_3_274" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="17" x="17" y="0">
              <path d={svgPaths.p1c90a780} fill="var(--fill-0, #FFF5EB)" id="Ellipse_11" />
            </mask>
            <g mask="url(#mask4_3_274)">
...
function ProfileCard() {
  return (
    <div className="absolute bg-white h-[93px] left-[20px] overflow-clip rounded-[24px] top-[132px] w-[353px]" data-name="Profile Card">
      ...
      <div className="absolute h-[79px] left-[147px] top-[16px] w-[100px]" data-name="Profile image" />
    </div>
  );
}
      ...
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 410 101">
        <g id="Bottom bar container">
          ...
          <g id="Bottom center icon container">
            ...
            <g id="Mask group">
              <mask height="26" id="mask0_3_229" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="186" y="24">
            ...
            <g id="Mask group_2">
              <mask height="26" id="mask1_3_229" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="17" x="204" y="24">
            ...
            <g id="Mask group_3">
              <mask height="26" id="mask2_3_229" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="17" x="204" y="24">
            ...
            <g id="Mask group_4">
              <mask height="26" id="mask3_3_229" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="17" x="204" y="24">
                <path d={svgPaths.p37d13d80} fill="var(--fill-0, #FFF5EB)" id="Ellipse_9" />
              </mask>
              <g mask="url(#mask3_3_229)">
...
export default function Component() {
  return (
    <div className="bg-[#ff8b0d] relative size-full" data-name="마이페이지">
