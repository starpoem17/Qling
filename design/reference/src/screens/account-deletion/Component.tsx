import svgPaths from "./svg-glp0o2c5aa";
      ...
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 410 101">
        <g id="Bottom bar container">
          ...
          <g id="Bottom center icon container">
            ...
            <g id="Mask group">
              <mask height="26" id="mask0_3_347" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="186" y="24">
            ...
            <g id="Mask group_2">
              <mask height="26" id="mask1_3_347" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="17" x="204" y="24">
                <path d={svgPaths.p37d13d80} fill="var(--fill-0, #FFF5EB)" id="Ellipse_5" />
              </mask>
              <g mask="url(#mask1_3_347)">
                <path d={svgPaths.p208b2d00} fill="var(--fill-0, #1A1A1A)" id="Ellipse_6" />
              </g>
            </g>
            <g id="Mask group_3">
              <mask height="26" id="mask2_3_347" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="17" x="204" y="24">
                <path d={svgPaths.p37d13d80} fill="var(--fill-0, #FFF5EB)" id="Ellipse_7" />
              </mask>
              <g mask="url(#mask2_3_347)">
                <path d={svgPaths.p208b2d00} fill="var(--fill-0, #1A1A1A)" id="Ellipse_8" />
              </g>
            </g>
            <g id="Mask group_4">
              <mask height="26" id="mask3_3_347" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="17" x="204" y="24">
                <path d={svgPaths.p37d13d80} fill="var(--fill-0, #FFF5EB)" id="Ellipse_9" />
              </mask>
              <g mask="url(#mask3_3_347)">
    ...
    <div className="absolute h-[26.34px] left-[24px] top-[12px] w-[33.116px]" data-name="Profile image container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 33.1161 26.3397">
        <g id="Profile image container">
          ...
          <g id="Mask group">
            <mask height="27" id="mask0_3_314" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
          ...
          <g id="Mask group_2">
            <mask height="27" id="mask1_3_314" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
          ...
          <g id="Mask group_3">
            <mask height="27" id="mask2_3_314" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
          ...
          <g id="Mask group_4">
            <mask height="27" id="mask3_3_314" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="17" x="17" y="0">
          ...
          <g id="Mask group_5">
            <mask height="27" id="mask4_3_314" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="17" x="17" y="0">
...
function Component6() {
  return (
    <div className="absolute bg-[#ff8b3d] h-[52px] left-[24px] overflow-clip rounded-[12px] top-[159px] w-[147px]" data-name="당첨 결과 알림 받기">
      <p className="absolute font-['SUIT:Bold',sans-serif] leading-[normal] left-[60px] not-italic text-[15px] text-white top-[16px] tracking-[-0.15px] whitespace-nowrap">취소</p>
    </div>
  );
}
...
function Component7() {
  return (
    <div className="absolute border border-[#b8b8b8] border-solid h-[52px] left-[183px] overflow-clip rounded-[12px] top-[159px] w-[99px]" data-name="당첨 결과 알림 받기">
      <p className="absolute font-['SUIT:Bold',sans-serif] leading-[normal] left-[35px] not-italic text-[#b8b8b8] text-[15px] top-[15px] tracking-[-0.15px] whitespace-nowrap">탈퇴</p>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="absolute bg-white drop-shadow-[0px_12px_20px_rgba(0,0,0,0.18)] h-[233px] left-[42px] rounded-[24px] top-[246px] w-[310px]" data-name="응모 완료 모달">
      <p className="absolute font-['SUIT:ExtraBold',sans-serif] leading-[normal] left-[17px] not-italic text-[#1a1a1e] text-[24px] top-[56px] tracking-[-0.48px] whitespace-nowrap">정말로 탈퇴 하실거에요? ㅠㅠ</p>
      <p className="-translate-x-1/2 absolute font-['SUIT:Bold',sans-serif] leading-[1.5] left-[155px] not-italic text-[#6e7076] text-[14px] text-center top-[103px] tracking-[-0.14px] w-[262px]">다시 큐링에 돌아오시지 못해요..ㅠㅠㅠㅠ</p>
      <Component6 />
      <Component7 />
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-[#ff8b0d] relative size-full" data-name="회원 탈퇴">
      <BottomBarContainer />
      ...
      <div className="absolute h-[857px] left-0 top-0 w-[393px]" data-name="Rectangle">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 393 857">
          <path d="M0 0H393V857H0V0Z" fill="var(--fill-0, black)" id="Rectangle" opacity="0.32" />
        </svg>
      </div>
      <Component5 />
    </div>
